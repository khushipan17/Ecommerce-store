						...
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<tr class="table-row">
									...
									<button class = "btn  btn-primary btn-round-md" name = "update"> Update </button>
							            <input type = "hidden"  name = "item_name" value = "<?php  echo $value['item_name'] ;?>"/>
									</form>
									</td>
									

									<td class = "column-6"> $ <?php echo $value['item_price'];?></td>


									<td class = "column-7 text-center" style = "margin-top:25%;">
									
									
									<form method = "post" action = "cartremove.php">
											 <div class = "form-group">

											  <button name = "remove" class = "btn btn-sm btn-outline-danger"><i class="fas fa-window-close"></i> </button>   
                                               <input type = "hidden"  name = "item_name" value = "<?php  echo $value['item_name'] ;?>"/>
											 </div>
